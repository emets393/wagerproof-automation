...
TABLE_NAME = "teamrankings_ops_last3"
...
# -----------------------------
df = pd.read_html("https://www.teamrankings.com/mlb/stat/opponent-on-base-plus-slugging-pct")[0]
df = df[["Team", "Last 3"]].copy()
df.columns = ["Team", "ops_last_3"]
...
final_df = df[["team", "ops_last_3"]].copy()
...
print("✅ Uploaded OPS Last 3 data with short names to Supabase.")